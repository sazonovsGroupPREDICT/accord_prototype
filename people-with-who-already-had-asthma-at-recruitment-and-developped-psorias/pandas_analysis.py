...
DATA_PATH = Path("data/people_with_who_already_had_asthma_at_recruitment_and_developped_psorias.tsv.gz")
DELIMITER = "\t"
...
DIAGNOSIS_ANCHOR_FIELD_IDS = [3786, 20002, 22127, 22147, 41270, 41271, 42014, 131494, 131742]
DIAGNOSIS_DATE_FIELD_IDS = [42014, 131494, 131742]
DIAGNOSIS_SPECIFIC_DATE_FIELD_IDS = [42014, 131494, 131742]
DIAGNOSIS_YEAR_FIELD_IDS = []
DIAGNOSIS_AGE_FIELD_IDS = [3786, 22147]
...
DIAGNOSIS_EXACT_CODES = ['1111', '1453', '49300', '49309', '49310', '49319', '49390', '49399', '6961', '6968']
...
CONDITION_RULES = [{'label': 'asthma', 'slug': 'asthma', 'relation': 'on_or_before_recruitment', 'diagnosis_field_ids': [20002, 41270, 41271], 'anchor_field_ids': [22127], 'date_field_ids': [42014, 131494], 'age_field_ids': [3786, 22147], 'exact_codes': ['1111', '49300', '49309', '49310', '49319', '49390', '49399'], 'prefixes': ['J45']}, {'label': 'psoriasis', 'slug': 'psoriasis', 'relation': 'after_recruitment', 'diagnosis_field_ids': [20002, 41270, 41271], 'anchor_field_ids': [], 'date_field_ids': [131742], 'age_field_ids': [], 'exact_codes': ['1453', '6961', '6968'], 'prefixes': ['L40']}]
...
cohort.to_parquet(output_dir / "people_with_who_already_had_asthma_at_recruitment_and_developped_psorias_cohort.parquet", index=False)
summary.to_json(output_dir / "people_with_who_already_had_asthma_at_recruitment_and_developped_psorias_summary.json", indent=2)

print("Saved:", output_dir / "people_with_who_already_had_asthma_at_recruitment_and_developped_psorias_cohort.parquet")
print("Selected columns:", selected_columns)

# This query uses condition-specific recruitment timeline rules rather than the generic procedure-sequence template.
